...
describe('interactive utilities', () => {
  let originalTestSpecInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalTestSpecInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalTestSpecInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalTestSpecInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
