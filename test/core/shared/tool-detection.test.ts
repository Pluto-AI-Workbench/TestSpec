...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('testspec-apply-change');
      expect(SKILL_NAMES).toContain('testspec-ff-change');
      expect(SKILL_NAMES).toContain('testspec-sync-specs');
      expect(SKILL_NAMES).toContain('testspec-archive-change');
      expect(SKILL_NAMES).toContain('testspec-bulk-archive-change');
      expect(SKILL_NAMES).toContain('testspec-verify-change');
      expect(SKILL_NAMES).toContain('testspec-onboard');
      expect(SKILL_NAMES).toContain('testspec-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'testspec-explore');
