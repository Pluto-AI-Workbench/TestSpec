...
describe('ZshGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid zsh completion script with header', () => {
      ...
      expect(script).toContain('#compdef testspec');
      expect(script).toContain('# Zsh completion script for TestSpec CLI');
      expect(script).toContain('_testspec() {');
    });
    ...
    it('should include all commands in the command list', () => {
      ...
      expect(script).toContain("'init:Initialize TestSpec'");
    ...
    it('should generate command completion functions', () => {
      ...
      expect(script).toContain('_testspec_init() {');
      expect(script).toContain('_testspec_validate() {');
    });
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain('_testspec_change_show() {');
      expect(script).toContain('_testspec_change_list() {');
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain("'*: :_testspec_complete_changes'");
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain("'*: :_testspec_complete_specs'");
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain("'*: :_testspec_complete_items'");
    });
    ...
    it('should sanitize command names with hyphens for function names', () => {
      ...
      expect(script).toContain('_testspec_my_command() {');
    });
    ...
    it('should handle complex nested subcommands with flags', () => {
      ...
      expect(script).toContain('_testspec_spec() {');
      expect(script).toContain('_testspec_spec_validate() {');
      expect(script).toContain('--strict');
      expect(script).toContain('--json');
      expect(script).toContain("'*: :_testspec_complete_specs'");
    });
    ...
    it('should generate script that ends with compdef registration', () => {
      ...
      expect(script.trim().endsWith('compdef _testspec testspec')).toBe(true);
    });
    ...
    it('should handle commands with no flags', () => {
      ...
      expect(script).toContain('_testspec_view() {');
