...
describe('BashGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid bash completion script with header', () => {
      ...
      expect(script).toContain('# Bash completion script for TestSpec CLI');
      expect(script).toContain('_testspec_completion() {');
    ...
    it('should generate script that ends with complete registration', () => {
      ...
      expect(script.trim().endsWith('complete -F _testspec_completion testspec')).toBe(true);
    });
    ...
    it('should handle empty command list', () => {
      ...
      expect(script).toContain('_testspec_completion() {');
      expect(script).toContain('complete -F _testspec_completion testspec');
    });
