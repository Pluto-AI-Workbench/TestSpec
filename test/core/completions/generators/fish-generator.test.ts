  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize TestSpec',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('# Fish completion script for TestSpec CLI');
      expect(script).toContain('function __fish_testspec');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_testspec_using_subcommand');
      expect(script).toContain('function __fish_testspec_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c testspec");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize TestSpec'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_testspec_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_testspec_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_testspec_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_testspec_items');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_testspec_changes');
      expect(script).toContain('testspec __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_testspec_specs');
      expect(script).toContain('testspec __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_testspec_items');
      expect(script).toContain('__fish_testspec_changes');
      expect(script).toContain('__fish_testspec_specs');
    });
