...
describe('ListCommand', () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = path.join(os.tmpdir(), `testspec-list-test-${Date.now()}`);
  ...
  describe('execute', () => {
    it('should handle missing testspec/changes directory', async () => {
    ...
    it('should handle empty changes directory', async () => {
      const changesDir = path.join(tempDir, 'testspec', 'changes');
