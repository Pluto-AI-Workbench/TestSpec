...
describe("FeedbackCommand", () => {
  ...
  describe("gh CLI availability check", () => {
    it("should use which command on Unix/macOS platforms", async () => {
      ...
      mockExecFileSync.mockReturnValue(
        "https://github.com/Pluto-AI-Workbench/TestSpec/issues/123\n",
      );
    ...
    it("should handle missing gh CLI with fallback", async () => {
      ...
      expect(consoleLogSpy).toHaveBeenCalledWith(
        expect.stringContaining(
          "https://github.com/Pluto-AI-Workbench/TestSpec/issues/new",
        ),
      );
    });
  ...
  describe("successful feedback submission", () => {
    it("should submit feedback via gh CLI when authenticated", async () => {
      ...
      expect(mockExecFileSync).toHaveBeenCalledWith(
        ...
        [
          ...
          "Feedback: Great tool!",
          "--body",
          expect.stringContaining("Submitted via TestSpec CLI"),
          "--label",
          "feedback",
        ],
    ...
    it("should include --body flag when body is provided", async () => {
      const issueUrl =
        "https://github.com/Pluto-AI-Workbench/TestSpec/issues/124";
      ...
      await feedbackCommand.execute("Title here", {
    ...
    it('should format title with "Feedback:" prefix', async () => {
      ...
      mockExecFileSync.mockReturnValue(
        "https://github.com/Pluto-AI-Workbench/TestSpec/issues/125\n",
      );
      ...
      expect(mockExecFileSync).toHaveBeenCalledWith(
        "gh",
        expect.arrayContaining(["--title", "Feedback: Test message"]),
        expect.any(Object),
      );
    });
    ...
    it("should include metadata in issue body", async () => {
      ...
      mockExecFileSync.mockReturnValue(
        "https://github.com/Pluto-AI-Workbench/TestSpec/issues/126\n",
      );
      ...
      expect(mockExecFileSync).toHaveBeenCalledWith(
        ...
        expect.arrayContaining([
          ...
          expect.stringMatching(
            /Submitted via TestSpec CLI[\s\S]*Version:[\s\S]*Platform:[\s\S]*Timestamp:/,
          ),
        ]),
        expect.any(Object),
      );
    ...
    it("should add feedback label to the issue", async () => {
      ...
      mockExecFileSync.mockReturnValue(
        "https://github.com/Pluto-AI-Workbench/TestSpec/issues/127\n",
      );
  ...
  describe("error handling", () => {
    ...
    it("should handle quotes in title and body without escaping (no shell injection)", async () => {
      ...
      mockExecFileSync.mockReturnValue(
        "https://github.com/Pluto-AI-Workbench/TestSpec/issues/128\n",
      );
