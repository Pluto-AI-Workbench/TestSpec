...
/**
 * Registry of all TestSpec CLI commands with their flags and metadata.
...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env TESTSPEC_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'change',
    description: 'Manage TestSpec change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage TestSpec specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
