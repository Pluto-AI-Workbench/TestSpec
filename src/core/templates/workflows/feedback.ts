...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about TestSpec with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about TestSpec.
...
5. **Submit on confirmation**
   - Use the \`testspec feedback\` command to submit
   - Format: \`testspec feedback "title" --body "body content"\`
