...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'testspec';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/testspec/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/testspec/
 * - Windows fallback: %APPDATA%/testspec/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/testspec/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/testspec/
 * - Windows fallback: %LOCALAPPDATA%/testspec/
 */
