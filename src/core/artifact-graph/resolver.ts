...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, 'testspec', 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/testspec/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/testspec/schemas/<name>/schema.yaml
