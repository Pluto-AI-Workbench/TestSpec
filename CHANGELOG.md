# @Pluto-AI-Workbench/TestSpec

## 1.3.1

### Patch Changes

- [#995](https://github.com/Pluto-AI-Workbench/TestSpec/pull/995) [`d1f3861`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/d1f3861d9ec694cc924b042b5da01963dcf93137) Thanks [@TabishB](https://github.com/TabishB)! - ### Bug Fixes
  ...
  - **Silent telemetry in firewalled environments** - PostHog network errors are now swallowed with a 1s timeout and retries/remote config disabled, so TestSpec no longer surfaces `PostHogFetchNetworkError` in locked-down networks. Telemetry opt-out is documented earlier in the README, installation guide, and CLI reference.

## 1.3.0

### Minor Changes

- [#952](https://github.com/Pluto-AI-Workbench/TestSpec/pull/952) [`cce787e`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/cce787ec4083da2b27781f6786f5ce0002909a7b) Thanks [@TabishB](https://github.com/TabishB)! - ### New Features
...
- [#760](https://github.com/Pluto-AI-Workbench/TestSpec/pull/760) [`61eb999`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/61eb999f7c6c0fc98d2e7f3678756fce6a3f4378) Thanks [@fsilvaortiz](https://github.com/fsilvaortiz)! - fix: OpenCode adapter now uses `.opencode/commands/` (plural) to match OpenCode's official directory convention. Fixes #748.

- [#759](https://github.com/Pluto-AI-Workbench/TestSpec/pull/759) [`afdca0d`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/afdca0d5dab1aa109cfd8848b2512333ccad60c3) Thanks [@fsilvaortiz](https://github.com/fsilvaortiz)! - fix: `TestSpec status` now exits gracefully when no changes exist instead of throwing a fatal error. Fixes #714.

## 1.2.0

### Minor Changes

- [#747](https://github.com/Pluto-AI-Workbench/TestSpec/pull/747) [`1e94443`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/1e94443a3551b228eecbc89e95d96d3b9600a192) Thanks [@TabishB](https://github.com/TabishB)! - ### New Features
  - **Profile system** - Choose between `core` (4 essential workflows) and `custom` (pick any subset) profiles to control which skills get installed. Manage profiles with the new `TestSpec config profile` command
  ...
  - **AI tool auto-detection** - `TestSpec init` now scans your project for existing tool directories (`.claude/`, `.cursor/`, etc.) and pre-selects detected tools
  ...
  - **Sync prunes deselected workflows** - `TestSpec update` now removes command files and skill directories for workflows you've deselected, keeping your project clean
  - **Config drift warning** - `TestSpec config list` warns when global config is out of sync with the current project
...
- [#627](https://github.com/Pluto-AI-Workbench/TestSpec/pull/627) [`afb73cf`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/afb73cf9ec59c6f8b26d0c538c0218c203ba3c56) Thanks [@TabishB](https://github.com/TabishB)! - ### Bug Fixes
  - **OpenCode command references** - Command references in generated files now use the correct `/opsx-` hyphen format instead of `/testspec:` colon format, ensuring commands work properly in OpenCode

## 1.1.0

### Minor Changes

- [#625](https://github.com/Pluto-AI-Workbench/TestSpec/pull/625) [`53081fb`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/53081fb2a26ec66d2950ae0474b9a56cbc5b5a76) Thanks [@TabishB](https://github.com/TabishB)! - ### Bug Fixes
...
- [#550](https://github.com/Pluto-AI-Workbench/TestSpec/pull/550) [`86d2e04`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/86d2e04cae76a999dbd1b4571f52fa720036be0c) Thanks [@jerome-benoit](https://github.com/jerome-benoit)! - ### Improvements
...
- [#596](https://github.com/Pluto-AI-Workbench/TestSpec/pull/596) [`e91568d`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/e91568deb948073f3e9d9bb2d2ab5bf8080d6cf4) Thanks [@TabishB](https://github.com/TabishB)! - ### Bug Fixes
...
- [#587](https://github.com/Pluto-AI-Workbench/TestSpec/pull/587) [`943e0d4`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/943e0d41026d034de66b9442d1276c01b293eb2b) Thanks [@TabishB](https://github.com/TabishB)! - ### Bug Fixes
  - Fixed incorrect archive path in onboarding documentation - the template now shows the correct path `TestSpec/changes/archive/YYYY-MM-DD-<name>/` instead of the incorrect `TestSpec/archive/YYYY-MM-DD--<name>/`

## 1.0.0

### Major Changes

- [#578](https://github.com/Pluto-AI-Workbench/TestSpec/pull/578) [`0cc9d90`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/0cc9d9025af367faa1688a7b2606a2549053cd3f) Thanks [@TabishB](https://github.com/TabishB)! - ## TestSpec 1.0 - The OPSX Release

  The workflow has been rebuilt from the ground up. OPSX replaces the old phase-locked `/TestSpec:*` commands with an action-based system where AI understands what artifacts exist, what's ready to create, and what each action unlocks.

  ### Breaking Changes
  - **Old commands removed** - `/TestSpec:proposal`, `/TestSpec:apply`, and `/TestSpec:archive` no longer exist
  - **Config files removed** - Tool-specific instruction files (`CLAUDE.md`, `.cursorrules`, `AGENTS.md`, `project.md`) are no longer generated
  - **Migration** - Run `TestSpec init` to upgrade. Legacy artifacts are detected and cleaned up with confirmation.
  ...
  **Now:** Flexible actions on a change. Edit any artifact anytime. The artifact graph tracks state automatically.
  ...
  | `/testspec:continue`     | Create one artifact at a time (step-through)         |
  | `/testspec:ff`           | Create all planning artifacts at once (fast-forward) |
  | `/testspec:apply`        | Implement tasks                                      |
  | `/testspec:verify`       | Validate implementation matches artifacts            |
  | `/testspec:sync`         | Sync delta specs to main specs                       |
  | `/testspec:archive`      | Archive completed change                             |
  | `/testspec:bulk-archive` | Archive multiple changes with conflict detection     |
  | `/testspec:onboard`      | Guided 15-minute walkthrough of complete workflow    |
  ...
  **Now:** Single `.claude/skills/` directory with YAML-fronted markdown files. Auto-detected by Claude Code, Cursor, Windsurf. Cross-editor compatible.
  ...
  ### New Features
  - **Onboarding skill** - `/testspec:onboard` walks new users through their first complete change with codebase-aware task suggestions and step-by-step narration (11 phases, ~15 minutes)
  ...
  - **Interactive setup** - `TestSpec init` shows animated welcome screen and searchable multi-select for choosing tools. Pre-selects already-configured tools for easy refresh.

  - **Customizable schemas** - Define custom artifact workflows in `TestSpec/schemas/` without touching package code. Teams can share workflows via version control.
...
- [#540](https://github.com/Pluto-AI-Workbench/TestSpec/pull/540) [`c4cfdc7`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/c4cfdc7c499daef30d8a218f5f59b8d9e5adb754) Thanks [@TabishB](https://github.com/TabishB)! - ### New Features
  - **Bulk archive skill** - Archive multiple completed changes in a single operation with `/testspec:bulk-archive`. Includes batch validation, spec conflict detection, and consolidated confirmation
...
- [#530](https://github.com/Pluto-AI-Workbench/TestSpec/pull/530) [`33466b1`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/33466b1e2a6798bdd6d0e19149173585b0612e6f) Thanks [@TabishB](https://github.com/TabishB)! - Add project-level configuration, project-local schemas, and schema management commands

  **New Features**
  - **Project-level configuration** - Configure TestSpec behavior per-project via `TestSpec/config.yaml`, including custom rules injection, context files, and schema resolution settings
  - **Project-local schemas** - Define custom artifact schemas within your project's `TestSpec/schemas/` directory for project-specific workflows
  - **Schema management commands** - New `TestSpec schema` commands (`list`, `show`, `export`, `validate`) for inspecting and managing artifact schemas (experimental)
...
- [#516](https://github.com/Pluto-AI-Workbench/TestSpec/pull/516) [`b5a8847`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/b5a884748be6156a7bb140b4941cfec4f20a9fc8) Thanks [@TabishB](https://github.com/TabishB)! - Add feedback command and Nix flake support

  **New Features**
  - **Feedback command** - Submit feedback directly from the CLI with `TestSpec feedback`, which creates GitHub Issues with automatic metadata inclusion and graceful fallback for manual submission
  - **Nix flake support** - Install and develop TestSpec using Nix with the new `flake.nix`, including automated flake maintenance and CI validation
...
- [#502](https://github.com/Pluto-AI-Workbench/TestSpec/pull/502) [`9db74aa`](https://github.com/Pluto-AI-Workbench/TestSpec/commit/9db74aa5ac6547efadaed795217cfa17444f2004) Thanks [@TabishB](https://github.com/TabishB)! - Add `/testspec:verify` command and fix vitest process storms

  **New Features**
  - **`/testspec:verify` command** - Validate that change implementations match their specifications
...
- eb152eb: Add Continue IDE support, shell completions, and `/testspec:explore` command

  **New Features**
  - **Continue IDE support** - TestSpec now generates slash commands for [Continue](https://continue.dev/), expanding editor integration options alongside Cursor, Windsurf, Claude Code, and others
  - **Shell completions for Bash, Fish, and PowerShell** - Run `TestSpec completion install` to set up tab completion in your preferred shell
  - **`/testspec:explore` command** - A new thinking partner mode for exploring ideas and investigating problems before committing to changes
  ...
  **Other**
  - Added optional anonymous usage statistics to help understand how TestSpec is used. This is **opt-out** by default - set `TestSpec_TELEMETRY=0` or `DO_NOT_TRACK=1` to disable. Only command names and version are collected; no arguments, file paths, or content. Automatically disabled in CI environments.
...
- 8dfd824: Add OPSX experimental workflow commands and enhanced artifact system
  ...
  **New Commands:**
  - `/testspec:ff` - Fast-forward through artifact creation, generating all needed artifacts in one go
  - `/testspec:sync` - Sync delta specs from a change to main specs
  - `/testspec:archive` - Archive completed changes with smart sync check
  ...
  **Artifact Workflow Enhancements:**
  ...
  - Per-change schema metadata via `.TestSpec.yaml` files
...
- 2e71835: Add `TestSpec config` command and Oh-my-zsh completions

  **New Features**
  - Add `TestSpec config` command for managing global configuration settings
...
- Add Continue slash command support so `TestSpec init` can generate `.continue/prompts/TestSpec-*.prompt` files with MARKDOWN frontmatter and `$ARGUMENTS` placeholder, and refresh them on `TestSpec update`.

- Add Antigravity slash command support so `TestSpec init` can generate `.agent/workflows/TestSpec-*.md` files with description-only frontmatter and `TestSpec update` refreshes existing workflows alongside Windsurf.
...
- 4758c5c: Add support for new AI tools with native slash command integration
  - **Gemini CLI**: Add native TOML-based slash command support for Gemini CLI with `.gemini/commands/TestSpec/` integration
...
- 8386b91: Add support for new AI assistants and configuration improvements
  ...
  - fix: recreate missing TestSpec template files in extend mode
...
- 082abb4: Add factory function support for slash commands and non-interactive init options
  ...
  - **Non-interactive init options**: Added `--tools`, `--all-tools`, and `--skip-tools` CLI flags to `TestSpec init` for automated initialization in CI/CD pipelines while maintaining backward compatibility with interactive mode

## 0.11.0

### Minor Changes

- 312e1d6: Add Amazon Q Developer CLI integration. TestSpec now supports Amazon Q Developer with automatic prompt generation in `.amazonq/prompts/` directory, allowing you to use TestSpec slash commands with Amazon Q's @-syntax.
...
- 2ae0484: Fix cross-platform path handling issues. This release includes fixes for joinPath behavior and slash command path resolution to ensure TestSpec works correctly across all platforms.

## 0.9.1

### Patch Changes

- 8210970: Fix TestSpec not working on Windows when Codex integration is selected. This release includes fixes for cross-platform path handling and normalization to ensure TestSpec works correctly on Windows systems.
...
- Add GitHub Copilot slash command support. TestSpec now writes prompts to `.github/prompts/TestSpec-{proposal,apply,archive}.prompt.md` with YAML frontmatter and `$ARGUMENTS` placeholder, and refreshes them on `TestSpec update`.

## 0.8.1

### Patch Changes

- d070d08: Fix CLI version mismatch and add a release guard that validates the packed tarball prints the same version as package.json via `TestSpec --version`.
...
- Add Codex slash command support. TestSpec now writes prompts directly to Codex's global directory (`~/.codex/prompts` or `$CODEX_HOME/prompts`) and refreshes them on `TestSpec update`.

## 0.7.0

### Minor Changes

- Add native Kilo Code workflow integration so `TestSpec init` and `TestSpec update` manage `.kilocode/workflows/TestSpec-*.md` files.
...
- Add TestSpec change proposals for CLI improvements and enhanced user experience
...
- Enhance `TestSpec init` with extend mode, multi-tool selection, and an interactive `AGENTS.md` configurator.

## 0.2.0

### Minor Changes

- ce5cead: - Add an `TestSpec view` dashboard that rolls up spec counts and change progress at a glance
  - Generate and update AI slash commands alongside the renamed `TestSpec/AGENTS.md` instructions file
  - Remove the deprecated `TestSpec diff` command and direct users to `TestSpec show`
